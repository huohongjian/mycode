...
(function(){
	this.HuoTable = function(element, cfg){
		this.ht;
		this.p;
	...
	var _ = new Object();
	HuoTable.prototype = _;
	
	_.init = function (element, cfg) {alert(cfg.colWidths)};
	_.appendTo = function (id) {};
	
	_.destroy = function(obj) {alert(obj)};
	
	_.loadData = function(df) {};
	

	_.createTable = function(thead, tbody, widths, attObj) {
		thead = thead || [];
		tbody = tbody || [];
