...
class Div{
	...
	function li($parameters=array()){
		...
		if($titlelink) $title = "<a href='list.html?id=$categoryid'>$title</a>";
		$body = $this->build_li($categoryid, $offset, $limit, $hasdate);
		echo $this->build_div($id, $class, $style, $title, $body);
	}
	
	private function build_li($categoryid, $offset, $limit, $hasdate){
		$article = new ArticleList($this->db);
		$rows = $article->getsByCatid($categoryid, $offset, $limit);
		$result = '';
		...
		foreach ($rows as $row){
			...
			$title = $row['title_alias'] ? $row['title_alias'] : $row['title'];
			$md = $hasdate ? "<span>$md</span>" : "";
			$row_title = $row['title'];
			$row_title = str_replace("'", "`", $row_title);
			$result .= "<li><a$class title='$row_title \n时间:$row[posttime] 点击:$row[counter]' href='browse.html?id=$row[artid]'>$title</a>$md</li>\n";
		}
		return $result;
	}
	...
	function scroll($parameters=array()){
		...
		if(!empty($rows)){
			foreach ($rows as $row) {
				...
				$lis .= "<li delay=$delay><a href=\"browse.html?id=$row[artid]\" target=\"_blank\">$t</a></li>\n";
			}
		}
	...
	function img($parameters=array()){
		...
		$image = new HomePageImage($this->db);
	...
	function link($parameters=array()){
		...
		$body = "
			<li>
				<a href='http://10.1.0.7' target='_blank'>国家局信息网</a>
				<a href='http://10.1.0.22:9080/netrep/' target='_blank'>财审网</a>
				<a href='http://10.1.0.10:7001/netrep/index.jsp' target='_blank'>国资网</a>
			</li>
			
			<li style='border-bottom:1px solid #DBDBDB; margin-bottom:3px; padding-bottom:3px;'>
				<a href='http://10.16.0.60/portal/' target='_blank'>省公司信息网</a>
				<a href='ftp://shengcw:8607956@10.16.0.128' target='_blank'>FTP128</a>
				<a href='ftp://10.16.0.129' target='_blank'>FTP129</a>
			</li>
			<li>
				<a href='http://www.sohu.com' target='_blank'>搜狐</a>
				<a href='http://www.sina.com' target='_blank'>新浪</a>
				<a href='http://www.163.com' target='_blank'>网易</a>
				<a href='http://www.zaobao.com' target='_blank'>早报网</a>
				<a href='http://news.sina.com.cn/m/globaltimes/' target='_blank'>环球时报</a>
			</li>
			<li>
				<a href='http://cn.yahoo.com/' target='_blank'>雅虎</a>
				<a href='http://www.qq.com/' target='_blank'>腾讯</a>
				<a href='http://www.inhe.net' target='_blank'>银河</a>
				<a href='http://www.xinhuanet.com' target='_blank'>新华网</a>
				<a href='http://www.chinanews.com.cn/' target='_blank'>中国新闻</a>
			</li>
			<li>
			...
			<li>
				...
				<a href='http://www.qidian.com/' target='_blank'>起点</a>
				<a href='http://www.readnovel.com/' target='_blank'>阅读</a>
				<a href='http://www.zol.com.cn/' target='_blank'>中关村</a>
				<a href='http://weather.tq121.com.cn/' target='_blank'>天气预报</a>
			</li>
			<li>
				<a href='http://www.tom.com' target='_blank'>TOM</a>
				<a href='http://www.21cn.com/' target='_blank'>21CN</a>
				<a href='http://www.duote.com/' target='_blank'>多特</a>
				<a href='http://www.pconline.com.cn/' target='_blank'>太平洋</a>
				<a href='http://www.9991.com/' target='_blank'>网址大全</a>
			</li>
			<li>
				<a href='http://www.cctv.com' target='_blank'>CCTV</a>
				<a href='http://www.chinadaily.net/' target='_blank'>Daily</a>
				<a href='http://www.yzdsb.com.cn/' target='_blank'>都市报</a>
			</li>
			<li>
				<a href='http://epaper.hebnews.cn/' target='_blank'>河北新闻</a>
			</li>
			";
