...
function Init(){
	$articleid = -1;//parseInt(window.location.href.getQuery('id') || -1);
//	menuFix();
		...
		function(back){
			...
			switch(json.msg){
				...
				case "addOK":
					...
					break;
				case "updateOK":alert('文章更新成功!'); break;
				default: 		alert('出现未知错误,请与系统管理员联系!'); break;
			}
		}
	);
}
...
function CreateEditor(width, height, toolbarset)
{
	...
	oFCKeditor.Height = height ? height : 320;
